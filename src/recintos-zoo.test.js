...
describe('Recintos do Zoologico', () => {
    ...
    test('Deve encontrar recintos para 2 leopardos', () => {

        const resultado = new RecintosZoo().analisaRecintos('LEOPARDO', 2);
        expect(resultado.erro).toBeFalsy();
        expect(resultado.recintosViaveis[0]).toBe('Recinto 5 (espaço livre: 2 total: 9)');
        expect(resultado.recintosViaveis.length).toBe(1);
    });

    test('Não deve encontrar recintos para 8 gazelas', () => {
